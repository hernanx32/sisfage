			  ...
			  <td><table width="800" border="0" align="center">
			    <tbody>
			      ...
			      <tr>
			        ...
			        <td width="249">%
			          <input name="bonif" type="number" id="bonif" class="validar" max="100" min="0" value="<?PHP echo $VAL9; ?>"></td>
		          </tr>
			      <tr>
			        ...
			        <td>%
			          <input name="flete" type="number" id="flete" class="validar" max="100" min="0"  value="<?PHP echo $VAL10; ?>"></td>
		          </tr>
			      <tr>
			        ...
			        <td>%
			          <input name="carg_finac" type="number" id="carg_finac" class="validar" max="100" min="0" value="<?PHP echo $VAL11; ?>"></td>
		          </tr>
		        </tbody>
		      </table></td>
		    </tr>
			  ...
			  <td><table width="800" border="0" align="center">
			    <tbody>
			      ...
			      <tr>
			        ...
			        <td height="21" align="center" bgcolor="#A1A1A1">$
		            <input name="IA4" type="number" disabled="disabled" id="IA4" class="validar" max="1000000" min="0" value="0"></td>
