...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2024 a las 15:05:52
...
-- Base de datos: `bases`
--
CREATE DATABASE IF NOT EXISTS `bases` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
USE `bases`;
...
--
-- Base de datos: `db_juncosas`
--
CREATE DATABASE IF NOT EXISTS `db_juncosas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
USE `db_juncosas`;
...
CREATE TABLE `usuario` (
  ...
  `id_imagen` int(15) NOT NULL,
  `fec_modif` date NOT NULL,
  `usu_modif` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
INSERT INTO `usuario` (`id_usuario`, `usuario`, `clave`, `email`, `id_sucursal`, `id_acceso`, `id_imagen`, `fec_modif`, `usu_modif`) VALUES
(1, 'admin', '2ee91e657461d0ae505c020861efbec6', 'webfsa@gmail.com', 1, 1, 1, '2023-12-06', 0);
...
('root', '[{\"db\":\"db_juncosas\",\"table\":\"usuario\"}]');
...
('root', '2024-01-02 04:15:07', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
