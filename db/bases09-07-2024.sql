...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2024 a las 13:14:27
...
CREATE TABLE `articulo` (
  ...
  `mod_iva` int(11) NOT NULL,
  `tipo_iva` float NOT NULL,
  `imp_interno` int(11) NOT NULL,
...
CREATE TABLE `imp_interno` (
  ...
  `desc_imp_int` varchar(10) NOT NULL,
  `porcen_imp_int` float(3,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 'Ayala Hernan', '', 'webfsa@gmail.com', 0, 3, '2024-07-17'),
(2, 'caro', '21232f297a57a5a743894a0e4a801fc3', 2, 'Carolina Britez', '', 'krolaunam@gmail.com', 1, 1, '2024-07-17'),
(12, 'jose', '2ee91e657461d0ae505c020861efbec6', 3, 'Alcides Jose', NULL, '', 1, 2, '2024-09-05');
...
--
ALTER TABLE `imp_interno`
  MODIFY `id_imp_interno` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rubro_sub`
  MODIFY `id_rubro_sub` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
